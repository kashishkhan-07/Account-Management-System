...
export default function AdminPanel() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans antialiased text-slate-800 flex flex-col md:flex-row relative">
      ...
      {/* DESKTOP SIDEBAR */}
      {/* ========================================================================= */}
      <aside className="hidden md:flex flex-col w-64 bg-slate-900 border-r border-slate-800 text-white min-h-screen shrink-0 sticky top-0 h-screen justify-between p-4 z-30">
        <div className="space-y-6">
          ...
          <div className="flex items-center space-x-3 px-2 py-1">
            ...
            <div className="flex flex-col">
              <span className="text-sm font-extrabold tracking-tight text-white leading-snug">
                Account Management
              </span>
          ...
          <nav className="space-y-1.5 pt-4">
            <a
              href="#users"
              className="flex items-center space-x-3 px-3.5 py-2.5 rounded-xl bg-blue-600 text-white text-xs font-bold shadow-md shadow-blue-600/20 transition"
            >
        ...
        <div className="pt-4 border-t border-slate-800 space-y-3">
          <div className="flex items-center space-x-3 px-2">
            <div className="w-9 h-9 rounded-full bg-blue-500/20 text-blue-400 border border-blue-400/30 flex items-center justify-center font-bold text-xs shrink-0">
          ...
          <button
            ...
            className="w-full flex items-center justify-center space-x-2 bg-slate-800 hover:bg-slate-700 text-slate-300 hover:text-white py-2 rounded-xl text-xs font-bold border border-slate-700 transition cursor-pointer"
          >
      ...
      {isSidebarOpen && (
        <div className="fixed inset-0 z-50 md:hidden flex">
          ...
          {/* Drawer Sidebar */}
          <div className="relative w-72 bg-slate-900 text-white min-h-full p-5 flex flex-col justify-between shadow-2xl z-10 space-y-6">
            <div className="space-y-6">
              ...
              <nav className="space-y-2 pt-2">
                <a
                  href="#users"
                  onClick={() => setIsSidebarOpen(false)}
                  className="flex items-center space-x-3 px-3.5 py-2.5 rounded-xl bg-blue-600 text-white text-xs font-bold shadow-md shadow-blue-600/20"
                >
            ...
            <div className="pt-4 border-t border-slate-800 space-y-3">
              ...
              <button
                ...
                className="w-full flex items-center justify-center space-x-2 bg-rose-600 text-white py-2 rounded-xl text-xs font-bold transition cursor-pointer"
              >
                <LogOut className="w-3.5 h-3.5" />
                <span>Logout</span>
              </button>
      ...
      <div className="flex-1 flex flex-col min-w-0">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              <button
                ...
                className="md:hidden p-2 rounded-xl text-slate-300 hover:text-white hover:bg-slate-800 border border-slate-700 transition cursor-pointer"
              ...
              <div className="flex items-center space-x-2.5">
                <div className="w-9 h-9 rounded-xl bg-blue-600 flex items-center justify-center shadow-md shadow-blue-500/30 shrink-0">
                  <Building2 className="w-5 h-5 text-white" />
                </div>
                <div className="flex items-center space-x-2">
                  ...
                  <span className="hidden sm:inline-block bg-blue-500/20 text-blue-400 text-[10px] uppercase font-extrabold px-2.5 py-0.5 rounded-full border border-blue-400/20 shrink-0">
                    ADMIN CONTROL
                  </span>
                </div>
              </div>
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6 w-full">
            ...
            <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm flex items-center justify-between">
              <div>
                ...
                <h3 className="text-2xl font-extrabold text-slate-900 mt-1">
                  ₹{stats.totalSystemBalance.toLocaleString("en-IN", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                </h3>
              </div>
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
            ...
            <div className="px-6 py-4 bg-slate-50/60 border-t border-slate-200 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs font-semibold text-slate-500">
              <span>
                Showing {filteredUsers.length > 0 ? (currentPage - 1) * limit + 1 : 0} to{" "}
                {Math.min(currentPage * limit, filteredUsers.length)} of {filteredUsers.length} user accounts
              </span>
              ...
              {totalPages > 1 && (
                <div className="flex items-center space-x-2">
                  <button
                    ...
                    className="px-3 py-1.5 rounded-lg border border-slate-200 hover:bg-slate-100 disabled:opacity-40 disabled:cursor-not-allowed transition cursor-pointer text-slate-700 flex items-center space-x-1"
                  >
      ...
      {showLogoutModal && (
        <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-4 animate-fadeIn">
          <div className="bg-white border border-slate-200 rounded-3xl shadow-2xl w-full max-w-sm p-6 text-center space-y-4">
            ...
            <div className="flex items-center space-x-3 pt-2">
              <button
                ...
                className="flex-1 py-2.5 rounded-xl text-xs font-bold border border-slate-200 hover:bg-slate-100 text-slate-600 transition cursor-pointer"
              >
                Cancel
              </button>
              <button
